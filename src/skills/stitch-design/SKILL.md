---
name: stitch-design
description: "Stitch 디자인 통합 입구. 프롬프트 개선, 디자인 시스템 합성(.stitch/DESIGN.md), Stitch MCP로 고품질 화면 생성/편집. /stitch-design \"프롬프트\" — 디자인 생성/편집 시 사용."
user_invocable: true
argument-hint: <"디자인 프롬프트"> [edit|generate|design-system]
allowed-tools:
  - "StitchMCP"
  - "Read"
  - "Write"
