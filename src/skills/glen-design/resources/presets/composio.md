...
- Dual-font identity: geometric sans-serif (Inter) for content, monospace (JetBrains Mono) for technical credibility
...
### Font Family
- **Primary**: `Inter`, with fallbacks: `Inter Fallback, ui-sans-serif, system-ui, Apple Color Emoji, Segoe UI Emoji, Segoe UI Symbol, Noto Color Emoji`
...
|------|------|------|--------|-------------|----------------|-------|
| Display / Hero | Inter | 64px (4rem) | 400 | 0.87 (ultra-tight) | normal | Massive, compressed headings |
| Section Heading | Inter | 48px (3rem) | 400 | 1.00 (tight) | normal | Major feature section titles |
| Sub-heading Large | Inter | 40px (2.5rem) | 400 | 1.00 (tight) | normal | Secondary section markers |
| Sub-heading | Inter | 28px (1.75rem) | 400 | 1.20 (tight) | normal | Card titles, feature names |
| Card Title | Inter | 24px (1.5rem) | 500 | 1.20 (tight) | normal | Medium-emphasis card headings |
| Feature Label | Inter | 20px (1.25rem) | 500 | 1.20 (tight) | normal | Smaller card titles, labels |
| Body Large | Inter | 18px (1.125rem) | 400 | 1.20 (tight) | normal | Intro paragraphs |
| Body / Button | Inter | 16px (1rem) | 400 | 1.50 | normal | Standard body text, nav links, buttons |
| Body Small | Inter | 15px (0.94rem) | 400 | 1.63 (relaxed) | normal | Longer-form body text |
| Caption | Inter | 14px (0.875rem) | 400 | 1.63 (relaxed) | normal | Descriptions, metadata |
| Label | Inter | 13px (0.81rem) | 500 | 1.50 | normal | UI labels, badges |
| Tag / Overline | Inter | 12px (0.75rem) | 500 | 1.00 (tight) | 0.3px | Uppercase overline labels |
| Micro | Inter | 12px (0.75rem) | 400 | 1.00 (tight) | 0.3px | Smallest sans-serif text |
...
- **Dual personality**: Inter carries the marketing voice — geometric, precise, friendly. JetBrains Mono carries the technical voice — credible, functional, familiar to developers.
...
- Nav links: Pure White (`#ffffff`) at standard body size (16px, Inter)
...
- Full round (9999px+): Outfit elements, avatar-like containers, decorative dots
...
- Pair Inter with JetBrains Mono to reinforce the developer-tool identity
...
- "Create a feature card with a near-black background (#000000), barely visible white border at 10% opacity, subtly rounded corners (4px), and a hard-offset shadow (4px right, 4px down, 15% black). Use Pure White for the title in Inter at 24px weight 500, and Ghost White (60% opacity) for the description at 16px."
...
- "Build a hero section on Void Black (#0f0f0f) with a massive heading at 64px, line-height 0.87, in Inter. Center the text. Add a subtle blue-to-black gradient glow behind the content. Include a white CTA button and a cyan-accented secondary button below."
...
- "Design a navigation bar on Void Black with the Composio wordmark in white on the left, 4-5 nav links in white Inter at 16px, and a white-fill CTA button on the right. Add a Border Mist 06 bottom border."
...
6. Always specify which font — Inter for marketing, JetBrains Mono for technical/code content
