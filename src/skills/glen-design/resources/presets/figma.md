...
**Key Characteristics:**
- Custom variable font (Inter) with unusual weight stops: 320, 330, 340, 450, 480, 540, 700
- Strictly black-and-white interface chrome — color exists only in product content
- Geist Mono for uppercase technical labels with wide letter-spacing
...
### Font Family
- **Primary**: `Inter`, with fallbacks: `Inter Fallback, Inter, system-ui, helvetica`
- **Monospace / Labels**: `Geist Mono`, with fallbacks: `Geist Mono Fallback, SF Mono, menlo`

### Hierarchy

| Role | Font | Size | Weight | Line Height | Letter Spacing | Notes |
|------|------|------|--------|-------------|----------------|-------|
| Display / Hero | Inter | 86px (5.38rem) | 400 | 1.00 (tight) | -1.72px | Maximum impact, extreme tracking |
| Section Heading | Inter | 64px (4rem) | 400 | 1.10 (tight) | -0.96px | Feature section titles |
| Sub-heading | Inter | 26px (1.63rem) | 540 | 1.35 | -0.26px | Emphasized section text |
| Sub-heading Light | Inter | 26px (1.63rem) | 340 | 1.35 | -0.26px | Light-weight section text |
| Feature Title | Inter | 24px (1.5rem) | 700 | 1.45 | normal | Bold card headings |
| Body Large | Inter | 20px (1.25rem) | 330–450 | 1.30–1.40 | -0.1px to -0.14px | Descriptions, intros |
| Body / Button | Inter | 16px (1rem) | 330–400 | 1.40–1.45 | -0.14px to normal | Standard body, nav, buttons |
| Body Light | Inter | 18px (1.13rem) | 320 | 1.45 | -0.26px to normal | Light-weight body text |
| Mono Label | Geist Mono | 18px (1.13rem) | 400 | 1.30 (tight) | 0.54px | Uppercase section labels |
| Mono Small | Geist Mono | 12px (0.75rem) | 400 | 1.00 (tight) | 0.6px | Uppercase tiny tags |

### Principles
- **Variable font precision**: Inter uses weights that most systems never touch — 320, 330, 340, 450, 480, 540. This creates hierarchy through subtle weight differences rather than dramatic jumps. The difference between 330 and 340 is nearly imperceptible but structurally significant.
...
- **Mono for structure**: Geist Mono in uppercase with positive letter-spacing (0.54px–0.6px) creates technical signpost labels.
...
### Do
- Use Inter with precise variable weights (320–540) — the granular weight control IS the design
...
- Use Geist Mono in uppercase with positive letter-spacing for labels
...
- "Create a hero on a vibrant multi-color gradient (green, yellow, purple, pink). Headline at 86px Inter weight 400, line-height 1.0, letter-spacing -1.72px. White text. White pill CTA button (50px radius, 8px 18px padding)."
- "Design a product tab bar with pill-shaped buttons (50px radius). Active: Black bg, white text. Inactive: transparent, black text. Inter at 20px weight 480."
- "Build a section label: Geist Mono 18px, uppercase, letter-spacing 0.54px, black text. Kern enabled."
- "Create body text at 20px Inter weight 330, line-height 1.40, letter-spacing -0.14px. Pure Black on white."
