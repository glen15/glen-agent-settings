...
- Geist weight 300 (light) for display — ethereal, whisper-thin headings
...
- Geist bold uppercase for specific CTA labels
...
### Font Families
- **Display**: `Geist`, fallback: `Geist Fallback`
- **Display Bold**: `Geist`, fallback: `Geist Fallback`
...
|------|------|------|--------|-------------|----------------|-------|
| Display Hero | Geist | 48px (3.00rem) | 300 | 1.08 (tight) | -0.96px | Whisper-thin, ethereal |
| Section Heading | Geist | 36px (2.25rem) | 300 | 1.17 (tight) | normal | Light display |
| Card Heading | Geist | 32px (2.00rem) | 300 | 1.13 (tight) | normal | Light card titles |
...
| Button Uppercase | Geist | 14px (0.88rem) | 700 | 1.10 (tight) | 0.7px | `text-transform: uppercase` |
...
### Principles
- **Light as the hero weight**: Geist at 300 is the defining typographic choice. Where other design systems use bold for impact, ElevenLabs uses lightness — thin strokes that feel like audio waveforms, creating intrigue through restraint.
...
- **Geist for emphasis**: A bold (700) uppercase variant of Geist appears only in specific CTA button labels with 0.7px letter-spacing — the one place where the type system gets loud.
...
**Uppercase Geist Button**
- Font: Geist 14px weight 700
...
- **Typography-led rhythm**: The light-weight Geist headings create visual "whispers" that draw the eye through vast white space.
...
### Do
- Use Geist weight 300 for all display headings — the lightness IS the brand
...
- Use Geist bold uppercase ONLY for specific CTA button labels

### Don't
- Don't use bold (700) Geist for headings — weight 300 is non-negotiable
...
- "Create a hero on white background. Headline at 48px Geist weight 300, line-height 1.08, letter-spacing -0.96px, black text. Subtitle at 18px Inter weight 400, line-height 1.60, letter-spacing 0.18px, #4e4e4e text. Two pill buttons: black (9999px, 0px 14px padding) and warm stone (rgba(245,242,239,0.8), 30px radius, 12px 20px padding, warm shadow rgba(78,50,23,0.04) 0px 6px 16px)."
- "Design a card: white background, 20px radius. Shadow: rgba(0,0,0,0.06) 0px 0px 0px 1px, rgba(0,0,0,0.04) 0px 1px 2px, rgba(0,0,0,0.04) 0px 2px 4px. Title at 32px Geist weight 300, body at 16px Inter weight 400 letter-spacing 0.16px, #4e4e4e."
...
- "Create an uppercase CTA label: 14px Geist weight 700, text-transform uppercase, letter-spacing 0.7px."
...
2. Geist 300 for headings — never bold, the lightness is the identity
