...
The typography uses Manrope — a custom proprietary font with a broad fallback stack including Japanese fonts, reflecting Pinterest's global reach. At display scale (70px, weight 600), Manrope creates large, inviting headlines. At smaller sizes, the system is compact: buttons at 12px, captions at 12–14px. The CSS variable naming system (`--comp-*`, `--sema-*`, `--base-*`) reveals a sophisticated three-tier design token architecture: component-level, semantic-level, and base-level tokens.
...
- Manrope custom font with global fallback stack (including CJK)
...
- **Warm Light** (`#e0e0d9`): Outfit button backgrounds, badges
...
### Font Family
- **Primary**: `Manrope`, fallbacks: `-apple-system, system-ui, Segoe UI, Roboto, Oxygen-Sans, Apple Color Emoji, Segoe UI Emoji, Segoe UI Symbol, Ubuntu, Cantarell, Fira Sans, Droid Sans, Helvetica Neue, Helvetica, ヒラギノ角ゴ Pro W3, メイリオ, Meiryo, ＭＳ Ｐゴシック, Arial`

### Hierarchy

| Role | Font | Size | Weight | Line Height | Letter Spacing | Notes |
|------|------|------|--------|-------------|----------------|-------|
| Display Hero | Manrope | 70px (4.38rem) | 600 | normal | normal | Maximum impact |
| Section Heading | Manrope | 28px (1.75rem) | 700 | normal | -1.2px | Negative tracking |
| Body | Manrope | 16px (1.00rem) | 400 | 1.40 | normal | Standard reading |
| Caption Bold | Manrope | 14px (0.88rem) | 700 | normal | normal | Strong metadata |
| Caption | Manrope | 12px (0.75rem) | 400–500 | 1.50 | normal | Small text, tags |
| Button | Manrope | 12px (0.75rem) | 400 | normal | normal | Button labels |
...
- **Single font family**: Manrope handles everything — no secondary display or monospace font detected.
...
- Use Manrope exclusively — one font for everything
...
- Don't use thin font weights — Manrope at 400 minimum
...
- "Create a hero: white background. Headline at 70px Manrope weight 600, plum black (#211922). Red CTA button (#e60023, 16px radius, 6px 14px padding). Secondary sand button (#e5e5e0, 16px radius)."
- "Design a pin card: white background, 16px radius, no shadow. Photography fills top, 16px Manrope weight 400 description below in #62625b."
...
- "Design the dark footer: #33332e background. Pinterest script logo in white. 12px Manrope links in #91918c."
...
4. Manrope is the only font — compact at 12px for UI, 70px for display
