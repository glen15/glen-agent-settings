...
- Inter variable font with non-standard weight stops (460, 540, 600, 700) — sits between conventional weight categories
...
### Font Family
- **Display & Body**: `Inter` — custom variable font with non-standard weight axis. Fallbacks: `system-ui, -apple-system, Segoe UI, Roboto, Oxygen, Ubuntu, Cantarell, Fira Sans, Droid Sans, Helvetica Neue`
- **Product UI** (referenced in brand): `Inter` / `Fraunces` / `JetBrains Mono` from Luzi Type — used in the product itself for sans-serif-to-serif transitions

### Hierarchy

| Role | Font | Size | Weight | Line Height | Letter Spacing | Notes |
|------|------|------|--------|-------------|----------------|-------|
| Display Hero | Inter | 64px | 540 | 0.96 | 0px | Maximum compression, powerful block headlines |
| Section Display | Inter | 48px | 460 | 0.96 | -1.32px | Lighter weight for section introductions |
| Section Heading | Inter | 48px | 460 | 0.96 | 0px | Alternate section heading without tracking |
| Feature Title | Inter | 28px | 540 | 1.14 | -0.63px | Feature block headlines, tighter |
| Sub-heading Large | Inter | 26px | 460 | 1.30 | 0px | Content sub-sections |
| Card Heading | Inter | 22px | 460 | 0.76 | -0.315px | Card title with extreme compression |
| Body Heading | Inter | 20px | 460 | 1.20 | 0px | Bold content intros |
| Body Heading Alt | Inter | 20px | 460 | 1.10 | -0.55px | Tighter variant for emphasis |
| Body Heading Relaxed | Inter | 20px | 460 | 1.25 | -0.4px | More breathing room variant |
| Emphasis Body | Inter | 18px | 540 | 1.50 | -0.135px | Medium-weight body for callouts |
| Body | Inter | 16px | 460 | 1.50 | 0px | Standard reading text — generous line-height |
| Button / UI Bold | Inter | 16px | 700 | 1.00 | 0px | Bold UI elements |
| Button / UI Semi | Inter | 16px | 600 | 1.00 | 0px | Semi-bold navigation and labels |
| Nav Link | Inter | 16px | 460 | 1.20 | 0px | Navigation items |
| Caption | Inter | 14px | 500 | 1.20 | -0.315px | Small labels, metadata |
| Caption Semi | Inter | 14px | 600 | 1.29 | 0px | Emphasized small text |
| Caption Body | Inter | 14px | 460 | 1.50 | 0px | Small body text |
| Micro Label | Inter | 12px | 700 | 1.50 | 0px | Smallest text — badges, tags |
...
- **Nav links**: Inter at 16px, weight 460/600 for hierarchy
...
### Do
- Use Inter at weight 460 as the default — it's slightly heavier than regular, which is the brand's typographic signature
...
- "Create a hero section with deep purple gradient background (#1b1938), 64px Inter heading at weight 540, line-height 0.96, white text at 95% opacity, and a warm cream button (#e9e5dd, 8px radius, #292827 text)"
- "Design a feature card with white background, 1px #dcd7d3 border, 16px radius, 20px Inter heading at weight 460, and 16px body text at weight 460 with 1.50 line-height in #292827"
- "Build a navigation bar with white background, Inter links at 16px weight 460, a warm cream CTA button (#e9e5dd, 8px radius), sticky positioning"
