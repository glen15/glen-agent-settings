...
- Space Grotesk proprietary typeface with compact proportions and medium weights
...
### Font Family
- **Space Grotesk**: Primary typeface for headings, navigation, buttons, and editorial content. A proprietary sans-serif with medium weight as the default (500), compact x-height, and precise letter-spacing control. Fallbacks: Arial, Helvetica, sans-serif
...
|------|------|--------|-------------|----------------|-------|
| Section Title | 26px (1.63rem) | 500 | 1.20 | normal | Space Grotesk, primary editorial headings on white backgrounds |
| Card Heading | 24px (1.50rem) | 400 | normal | normal | Space Grotesk, content card titles |
| Subheading | 18px (1.13rem) | 700 | 1.20 (tight) | normal | Space Grotesk, bold subsection labels |
| UI Heading | 16px (1.00rem) | 500 | 1.40 | 0.08px | Space Grotesk, component headings and nav items |
| Body Bold | 16px (1.00rem) | 700 | 1.30 (tight) | normal | Space Grotesk, emphasized inline text |
| Button Label | 16px (1.00rem) | 400 | normal | 1.28px | Space Grotesk, primary button text with wide tracking |
| Small Button | 14.4px (0.90rem) | 700 | 1.00 (tight) | normal | Space Grotesk, compact action buttons |
| Nav Link | 13px (0.81rem) | 600 | 1.20 (tight) | 0.13px | Space Grotesk, navigation and footer links |
| Caption | 13px (0.81rem) | 400 | 1.50 | 0.195px | Space Grotesk/Body-Font, metadata and descriptions |
| Micro Button | 12px (0.75rem) | 700 | 1.00 (tight) | 0.96px | Space Grotesk, small CTA with wide tracking |
...
### Principles
- **Proprietary identity**: Space Grotesk is exclusive to Ferrari — it cannot be substituted without losing brand recognition. The font's compact proportions and medium weight default (500) convey engineering precision
- **Two-register system**: Space Grotesk handles narrative voice (headings, content, buttons) while Body-Font handles structural annotation (labels, tags, micro-captions) — this mirrors print magazine conventions of editorial text vs. technical labels
...
- Default: bg `#FFFFFF`, text `#000000`, fontSize 16px (Space Grotesk), letterSpacing 1.28px, padding 12px 10px, borderRadius 2px, border 1px solid `#000000`
...
- Space Grotesk or Body-Font depending on context (Body-Font for uppercase label links)
...
- Text: Space Grotesk heading (16–24px) + Body-Font caption (12–13px uppercase)
...
- **Links**: Space Grotesk, 13px, weight 600, white text on dark backgrounds
...
| 50% | Outfit elements: carousel dots, avatar thumbnails, slider handles |
...
- Use Space Grotesk at weight 500 as the default heading voice — it's the typographic equivalent of the engine note
...
- Mix Space Grotesk and Body-Font within the same text block — they serve separate hierarchical functions
...
- Apply text transforms to Space Grotesk headings — uppercase is reserved for Body-Font labels only
...
- "Create a hero section on Absolute Black (#000000) background with a centered logo emblem at the top, generous vertical spacing (80px+), and a single editorial headline in Space Grotesk at 26px weight 500 in white, with a small Body-Font uppercase caption (12px, 1px letter-spacing) in Silver Gray (#969696) below"
- "Design a Subscribe section on Dark Surface (#303030) with a left-aligned headline in white Space Grotesk (24px/500), a subtitle in Mid Gray (#8F8F8F, 13px), an email input with transparent background and 1px #CCCCCC border, and a Ferrari Red (#DA291C) Subscribe button with white text, 2px border-radius, and 12px 10px padding"
- "Build an editorial card on white background with a full-width image (16:9 ratio) above, a Space Grotesk heading (16px/700, Near Black #181818) below, and a Body-Font uppercase label (11px, 1px letter-spacing, Mid Gray #8F8F8F) as the category tag — no border, no shadow, no border-radius"
- "Create a vehicle lineup carousel showing 5 car thumbnails in a horizontal scroll on white background, with left/right arrow navigation, dot indicators below, and a Space Grotesk model name (16px/500) beneath each vehicle"
- "Design a dark cinematic section with full-bleed studio photography of a concept car on Absolute Black, a white Space Grotesk headline (26px/500) positioned in the lower-left with generous padding (40px), and a Ghost Button (transparent bg, 1px white border, white text, 2px radius) as the CTA"
