...
The design language bridges two worlds with a dual-typeface system: Space Grotesk, a custom display serif with tight tracking, gives headlines the gravitas of a technology manifesto, while Inter handles all body and UI text with geometric Swiss precision. This serif/sans pairing creates a "confident authority meets engineering clarity" personality that perfectly reflects an enterprise AI platform.
...
- Dual custom typeface: Space Grotesk (display serif) + Inter (body sans)
...
- Geist Mono for code and technical labels with uppercase transforms
...
### Font Family
- **Display**: `Space Grotesk`, with fallbacks: `Space Grotesk, Inter, ui-sans-serif, system-ui`
- **Body / UI**: `Inter`, with fallbacks: `Inter, Arial, ui-sans-serif, system-ui`
- **Code**: `Geist Mono`, with fallbacks: `Arial, ui-sans-serif, system-ui`
...
|------|------|------|--------|-------------|----------------|-------|
| Display / Hero | Space Grotesk | 72px (4.5rem) | 400 | 1.00 (tight) | -1.44px | Maximum impact, serif authority |
| Display Secondary | Space Grotesk | 60px (3.75rem) | 400 | 1.00 (tight) | -1.2px | Large section headings |
| Section Heading | Inter | 48px (3rem) | 400 | 1.20 (tight) | -0.48px | Feature section titles |
| Sub-heading | Inter | 32px (2rem) | 400 | 1.20 (tight) | -0.32px | Card headings, feature names |
| Feature Title | Inter | 24px (1.5rem) | 400 | 1.30 | normal | Smaller section titles |
| Body Large | Inter | 18px (1.13rem) | 400 | 1.40 | normal | Intro paragraphs |
| Body / Button | Inter | 16px (1rem) | 400 | 1.50 | normal | Standard body, button text |
| Button Medium | Inter | 14px (0.88rem) | 500 | 1.71 (relaxed) | normal | Smaller buttons, emphasized labels |
| Caption | Inter | 14px (0.88rem) | 400 | 1.40 | normal | Metadata, descriptions |
| Uppercase Label | Inter / Geist Mono | 14px (0.88rem) | 400 | 1.40 | 0.28px | Uppercase section labels |
| Small | Inter | 12px (0.75rem) | 400 | 1.40 | normal | Smallest text, footer links |
| Code Micro | Geist Mono | 8px (0.5rem) | 400 | 1.40 | 0.16px | Tiny uppercase code labels |

### Principles
- **Serif for declaration, sans for utility**: Space Grotesk carries the brand voice at display scale — its serif terminals give headlines the authority of published research. Inter handles everything functional with Swiss-geometric neutrality.
- **Negative tracking at scale**: Space Grotesk uses -1.2px to -1.44px letter-spacing at 60–72px, creating dense, impactful text blocks.
- **Single body weight**: Nearly all Inter usage is weight 400. Weight 500 appears only for small button emphasis. The system relies on size and spacing, not weight contrast.
- **Uppercase code labels**: Geist Mono uses uppercase with positive letter-spacing (0.16–0.28px) for technical tags and section markers.
...
**Uppercase Code Tags**
- Geist Mono in uppercase with letter-spacing
...
- Use Space Grotesk for display headings (72px, 60px) with negative letter-spacing
- Use Inter for all body and UI text at weight 400
...
- Apply uppercase + letter-spacing on Geist Mono for section labels
...
- Don't skip the serif/sans hierarchy — Space Grotesk for headlines, Inter for body
...
- "Create a hero section on Pure White (#ffffff) with Space Grotesk at 72px weight 400, line-height 1.0, letter-spacing -1.44px. Cohere Black text. Subtitle in Inter at 18px weight 400, line-height 1.4."
- "Design a feature card with 22px border-radius, 1px solid Lightest Gray (#f2f2f2) border on white. Title in Inter at 32px, letter-spacing -0.32px. Body in Inter at 16px, Muted Slate (#93939f)."
- "Build a ghost button: transparent background, Cohere Black text in Inter at 16px. On hover, text shifts to Interaction Blue (#1863dc) with 0.8 opacity. Focus: 2px solid Interaction Blue outline."
- "Create a deep purple full-width section with white text. Space Grotesk at 60px for the heading. Product screenshot floats within using 22px border-radius."
- "Design a section label using Geist Mono at 14px, uppercase, letter-spacing 0.28px. Muted Slate (#93939f) text."

### Iteration Guide
1. Focus on ONE component at a time
2. Always use 22px radius for primary cards — "the Cohere card roundness"
3. Specify the typeface — Space Grotesk for headlines, Inter for body, Geist Mono for labels
