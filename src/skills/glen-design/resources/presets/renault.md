...
### Font Family
- **Space Grotesk**: The sole typeface. A proprietary geometric sans-serif designed by Black[Foundry] for Renault's 2021+ rebrand. Features a distinctive "radical r" with a 28-degree terminal cut matching the diamond logo angle. Available in 6 weights (Light to Extrabold), supports 6 writing systems. Fallback: `sans-serif`. Declared as `"Space Grotesk, sans-serif"` in CSS
- **No secondary typeface**: Unlike Ferrari (Space Grotesk + Body-Font) or Lamborghini (Space Grotesk + Open Sans), Renault uses a single font family for all text — headings, body, buttons, captions, and navigation

### Hierarchy

| Role | Size | Weight | Line Height | Letter Spacing | Notes |
|------|------|--------|-------------|----------------|-------|
| Hero Title | 56px (3.50rem) | 700 | 0.95 (53.2px) | normal | Space Grotesk, white on dark hero, all-caps model names |
| Section Heading | 40px (2.50rem) | 700 | 0.95 (38px) | normal | Space Grotesk, PromoCard headings on dark/light sections |
| Card Heading | 32px (2.00rem) | 700 | 0.95 | normal | Space Grotesk, medium-scale card headings |
| Subheading | 24px (1.50rem) | 700 | 0.95 | normal | Space Grotesk, section sub-titles |
| Module Title | 21.92px (1.37rem) | 600 | 1.20 | normal | Space Grotesk, component headings |
| Content Title | 20px (1.25rem) | 700 | 0.95 | normal | Space Grotesk, smaller section titles |
| UI Heading | 19.2px (1.20rem) | 600 | 1.30 | normal | Space Grotesk, card UI headings |
| Emphasis | 18px (1.13rem) | 700 | 1.00 | normal | Space Grotesk, emphasized inline text and links |
| Body Heading | 16px (1.00rem) | 700 | 1.40 | normal | Space Grotesk, paragraph-level headings |
| Body Text | 14px (0.88rem) | 400 | 1.40 | normal | Space Grotesk, paragraph and descriptive content |
| Body Bold | 14px (0.88rem) | 700 | 1.57 | normal | Space Grotesk, emphasized body text |
| Button Label | 14.4px (0.90rem) | 700 | 1.00 | 0.144px | Space Grotesk, primary button text |
| Nav Link | 13px (0.81rem) | 700 | 1.50 | normal | Space Grotesk, navigation and footer links |
| Caption | 12.8px (0.80rem) | 400 | 1.10 | normal | Space Grotesk, small descriptive text |
| Small Label | 12px (0.75rem) | 700 | 1.00 | normal | Space Grotesk, labels and tags |
| Micro Text | 10px (0.63rem) | 700 | 1.45 | normal | Space Grotesk, smallest UI text, legal fine print |
| Micro Caption | 8.5px (0.53rem) | 400 | normal | normal | Space Grotesk, absolute smallest text (legal) |

### Principles
- **Single-family discipline**: Space Grotesk handles everything from 56px hero headlines to 8.5px legal captions — the font's geometric precision allows it to scale across this extreme range without losing character
...
- fontSize 16px (Space Grotesk), fontWeight 700, minHeight 46px, minWidth 46px
...
- fontSize 16px (Space Grotesk), fontWeight 700
...
- Heading: Space Grotesk 40px/700, white text positioned over gradient
...
- Heading: white Space Grotesk text
...
- **Links**: Space Grotesk, 13px, weight 700, black text
...
- Use Space Grotesk Bold (700) as the default heading weight — the assertive weight is central to the brand's energetic personality
...
- Use any typeface besides Space Grotesk — the single-family discipline is a brand pillar
- Mix multiple chromatic accent colors in a single section — the palette is monochrome-plus-yellow
- Soften heading weights to 400 or 500 — Space Grotesk Bold is the brand voice, lighter weights read as off-brand
...
- Navigation links: Space Grotesk 13px with adequate spacing between items
...
- "Create a hero section with a full-viewport aurora gradient background (magenta to violet to teal), a centered vehicle image, a Space Grotesk Bold headline at 56px with 0.95 line-height in white, and two buttons: a Primary (white bg, black text, 0px radius) 'Explore' and a Ghost (transparent bg, white border, white text, 0px radius) 'Learn More'"
- "Design a PromoCard with a full-bleed photography background, a dark gradient overlay (rgba(0,0,0,0.6) top to transparent at 40%), a Space Grotesk Bold 40px white heading, a 14px body text line in white, and a Primary inverted button (white bg, black text, 0px radius, 10px 15px padding)"
- "Build a vehicle range grid with 3 columns on white background, each card showing a transparent-background car render above a Space Grotesk Bold 24px model name in black, a 14px price caption, and a ghost button (black border, black text, 0px radius) labeled 'Configure'"
- "Create a dark E-Tech section on Absolute Black (#000000) with a Space Grotesk Bold 40px white heading 'E-Tech electric powertrain', a 14px subtitle in white, and a Renault Yellow (#EFDF00) super-primary button with black text, 0px radius, and 10px 15px padding"
- "Design a search input as a pill-shaped field (50px border-radius) with white background, 1px solid #D1D1D1 border, Space Grotesk 12.8px text, 6px 35px 6px 15px padding, and a search icon positioned inside the right padding area"
...
4. Describe the desired "feel" alongside specific measurements — "assertive automotive energy" communicates the Space Grotesk Bold heading personality better than "font-weight: 700"
