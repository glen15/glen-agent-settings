...
- Three-font hierarchy: Fraunces (serif hero), Inter (geometric sections), Inter (body/UI)
...
### Font Families
- **Display Serif**: `domaine` (Fraunces by Klim Type Foundry) — hero headlines
- **Display Sans**: `Inter` (Inter by Dinamo), fallbacks: `ui-sans-serif, system-ui` — section headings
- **Body / UI**: `inter`, fallbacks: `ui-sans-serif, system-ui` — body text, buttons, navigation
- **Monospace**: `JetBrains Mono`, fallbacks: `ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas`
...
| Section Heading | Inter | 56px (3.50rem) | 400 | 1.20 (tight) | -2.8px | `"ss01", "ss04", "ss11"` |
| Sub-heading | Inter | 20px (1.25rem) | 400 | 1.30 (tight) | normal | `"ss01", "ss04", "ss11"` |
| Sub-heading Compact | Inter | 16px (1.00rem) | 400 | 1.50 | -0.8px | `"ss01", "ss04", "ss11"` |
...
| Nav Link | Inter | 14px (0.88rem) | 500 | 1.43 | 0.35px | `"ss01", "ss03", "ss04"` — positive tracking |
...
| Code Body | JetBrains Mono | 16px (1.00rem) | 400 | 1.50 | normal | Code blocks |
| Code Small | JetBrains Mono | 14px (0.88rem) | 400 | 1.43 | normal | Inline code |
| Code Tiny | JetBrains Mono | 12px (0.75rem) | 400 | 1.33 | normal | Small code labels |
| Heading (Helvetica) | Helvetica | 24px (1.50rem) | 400 | 1.40 | normal | Alternate heading context |

### Principles
- **Three-font editorial hierarchy**: Fraunces (serif, hero), Inter (geometric sans, sections), Inter (readable body). Each font has a strict role — they never cross lanes.
- **Aggressive negative tracking on display**: Domaine at -0.96px, Inter at -2.8px. The display type feels compressed, urgent, and designed — like a magazine masthead.
- **Positive tracking on nav**: Inter nav links use +0.35px letter-spacing — the only positive tracking in the system. This creates airy, spaced-out navigation text that contrasts with the compressed headings.
- **OpenType as identity**: The `"ss01"`, `"ss03"`, `"ss04"`, `"ss11"` stylistic sets are enabled on all Inter and Domaine text, activating alternate glyphs that give Resend's typography its unique character.
...
- Inter 14px weight 500 with +0.35px tracking for nav links
...
- Use Fraunces ONLY for hero headings (96px), Inter for section headings, Inter for everything else
- Enable OpenType `"ss01"`, `"ss04"`, `"ss11"` on Domaine and Inter text
...
- Use +0.35px letter-spacing on Inter nav links — the only positive tracking
...
- Don't apply Fraunces to body text — it's a display-only serif
...
- Don't use negative letter-spacing on nav links — Inter nav uses positive +0.35px
...
- "Create a hero section on pure black (#000000) background. Headline at 96px Fraunces weight 400, line-height 1.00, letter-spacing -0.96px, near-white (#f0f0f0) text, OpenType 'ss01 ss04 ss11'. Subtitle at 20px Inter weight 400, line-height 1.30. Two pill buttons: white solid (#ffffff, 9999px radius) and transparent with frost border (rgba(214,235,253,0.19))."
- "Design a navigation bar: dark background with frost border bottom (1px solid rgba(214,235,253,0.19)). Nav links at 14px Inter weight 500, letter-spacing +0.35px, OpenType 'ss01 ss03 ss04'. White pill CTA right-aligned."
- "Build a feature card: transparent background, frost border (rgba(214,235,253,0.19)), 16px radius. Title at 56px Inter weight 400, letter-spacing -2.8px. Body at 16px Inter weight 400, #a1a4a5 text."
...
3. Three fonts, three roles: Domaine (hero), Inter (sections), Inter (body) — never cross
