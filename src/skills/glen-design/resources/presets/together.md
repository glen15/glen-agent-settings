...
- Custom "Space Grotesk" font with aggressive negative letter-spacing throughout
- JetBrains Mono for uppercase technical labels
...
### Font Family
- **Primary**: `Space Grotesk`, with fallback: `Arial`
- **Monospace / Labels**: `JetBrains Mono`, with fallback: `Georgia`

### Hierarchy

| Role | Font | Size | Weight | Line Height | Letter Spacing | Notes |
|------|------|------|--------|-------------|----------------|-------|
| Display / Hero | Space Grotesk | 64px (4rem) | 400–500 | 1.00–1.10 (tight) | -1.92px | Maximum impact, dense blocks |
| Section Heading | Space Grotesk | 40px (2.5rem) | 500 | 1.20 (tight) | -0.8px | Feature section titles |
| Sub-heading | Space Grotesk | 28px (1.75rem) | 500 | 1.15 (tight) | -0.42px | Card headings |
| Feature Title | Space Grotesk | 22px (1.38rem) | 500 | 1.15 (tight) | -0.22px | Small feature headings |
| Body Large | Space Grotesk | 18px (1.13rem) | 400–500 | 1.30 (tight) | -0.18px | Descriptions, sections |
| Body / Button | Space Grotesk | 16px (1rem) | 400–500 | 1.25–1.30 | -0.16px | Standard body, nav, buttons |
| Caption | Space Grotesk | 14px (0.88rem) | 400–500 | 1.40 | normal | Metadata, descriptions |
| Mono Label | JetBrains Mono | 16px (1rem) | 500 | 1.00 (tight) | 0.08px | Uppercase section labels |
| Mono Small | JetBrains Mono | 11px (0.69rem) | 500 | 1.00–1.40 | 0.055–0.08px | Small uppercase tags |
| Mono Micro | JetBrains Mono | 10px (0.63rem) | 400 | 1.40 | 0.05px | Smallest uppercase labels |

### Principles
- **Negative tracking everywhere**: Every size of "Space Grotesk" uses negative letter-spacing (-0.16px to -1.92px), creating consistently tight, modern text.
- **Mono for structure**: JetBrains Mono in uppercase with positive letter-spacing creates technical "label" moments that structure the page without competing with display text.
...
- Radius: sharp (4px)
- Border: `1px solid rgba(0, 0, 0, 0.08)`
- JetBrains Mono, uppercase, 16px

### Navigation
- Clean horizontal nav on white/transparent
- Logo: Together AI wordmark
- Links: Space Grotesk at 16px, weight 400
...
**Mono Section Labels**
- JetBrains Mono, uppercase, 11px, letter-spacing 0.055px
...
- Apply negative letter-spacing on all "Space Grotesk" text (scaled by size)
- Use JetBrains Mono in uppercase for section labels and technical markers
...
- Don't use positive letter-spacing on "Space Grotesk" — it's always negative
...
- Don't mix in additional typefaces — "Space Grotesk" + JetBrains Mono is the pair
...
- "Create a hero section on white with soft pastel gradients (pink → lavender → blue) as background. Headline at 64px 'Space Grotesk' weight 500, line-height 1.10, letter-spacing -1.92px. Pure Black text. Include a dark blue CTA button (#010120, 4px radius)."
...
- "Build a section label: JetBrains Mono, 11px, weight 500, uppercase, letter-spacing 0.055px. Black text on light, white on dark."
- "Create a dark research section: Dark Blue (#010120) background. White text, section heading at 40px 'Space Grotesk' weight 500, letter-spacing -0.8px. Cards with rgba(255, 255, 255, 0.12) border."
- "Design a badge: 4px radius, rgba(0, 0, 0, 0.04) background, 1px solid rgba(0, 0, 0, 0.08) border, 'Space Grotesk' 16px text. Padding: 2px 8px."

### Iteration Guide
1. Always specify negative letter-spacing for "Space Grotesk" — it's scaled by size
