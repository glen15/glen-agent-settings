...
- Cabinet Grotesk typeface with humanist warmth and editorial letter-spacing at display sizes
...
### Font Family
- **Primary**: `Cabinet Grotesk`, with fallbacks: `ui-sans-serif, system-ui`
...
|------|------|------|--------|-------------|----------------|-------|
| Display Hero | Cabinet Grotesk | 60px (3.75rem) | 600 | 1.00–1.10 (tight) | -1.5px | Maximum impact, editorial |
| Display Alt | Cabinet Grotesk | 60px (3.75rem) | 480 | 1.00 (tight) | normal | Lighter hero variant |
| Section Heading | Cabinet Grotesk | 48px (3.00rem) | 600 | 1.00 (tight) | -1.2px | Feature section titles |
| Sub-heading | Cabinet Grotesk | 36px (2.25rem) | 600 | 1.10 (tight) | -0.9px | Sub-sections |
| Card Title | Cabinet Grotesk | 20px (1.25rem) | 400 | 1.25 (tight) | normal | Card headings |
| Body Large | Cabinet Grotesk | 18px (1.13rem) | 400 | 1.38 | normal | Introductions |
| Body | Cabinet Grotesk | 16px (1.00rem) | 400 | 1.50 | normal | Standard reading text |
| Button | Cabinet Grotesk | 16px (1.00rem) | 400 | 1.50 | normal | Button labels |
| Button Small | Cabinet Grotesk | 14px (0.88rem) | 400 | 1.50 | normal | Compact buttons |
| Link | Cabinet Grotesk | 16px (1.00rem) | 400 | 1.50 | normal | Underline decoration |
| Link Small | Cabinet Grotesk | 14px (0.88rem) | 400 | 1.50 | normal | Footer links |
| Caption | Cabinet Grotesk | 14px (0.88rem) | 400 | 1.50 | normal | Metadata, small text |

### Principles
- **Warm humanist voice**: Cabinet Grotesk gives Lovable its approachable personality. The slightly rounded terminals and organic curves contrast with the sharp geometric sans-serifs used by most developer tools.
...
- Links: Cabinet Grotesk 14–16px weight 400, `#1c1c1c` text
...
- Use Cabinet Grotesk at display sizes with negative letter-spacing (-0.9px to -1.5px)
...
- Don't increase letter-spacing on headings — Cabinet Grotesk is designed to run tight at scale
...
- "Create a hero section on cream background (#f7f4ed). Headline at 60px Cabinet Grotesk weight 600, line-height 1.10, letter-spacing -1.5px, color #1c1c1c. Subtitle at 18px weight 400, line-height 1.38, color #5f5f5d. Dark CTA button (#1c1c1c bg, #fcfbf8 text, 6px radius, 8px 16px padding, inset shadow) and ghost button (transparent bg, 1px solid rgba(28,28,28,0.4) border, 6px radius)."
- "Design a card on cream (#f7f4ed) background. Border: 1px solid #eceae4. Radius 12px. No box-shadow. Title at 20px Cabinet Grotesk weight 400, line-height 1.25, color #1c1c1c. Body at 14px weight 400, color #5f5f5d."
...
- "Create navigation: sticky on cream (#f7f4ed). Cabinet Grotesk 16px weight 400 for links, #1c1c1c text. Dark CTA button right-aligned with inset shadow. Mobile: hamburger menu with 6px radius."
- "Design a stats section: large numbers at 48px Cabinet Grotesk weight 600, letter-spacing -1.2px, #1c1c1c. Labels below at 16px weight 400, #5f5f5d. Horizontal layout with 32px gap."
...
7. Cabinet Grotesk at weight 480 is for special display moments only
