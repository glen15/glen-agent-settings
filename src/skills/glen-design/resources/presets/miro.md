...
### Font Families
- **Display**: `Inter`, fallback: Placeholder — `"blwf", "cv03", "cv04", "cv09", "cv11"`
- **Display Variants**: `Inter`, `Inter Italic`, `Inter`
...
|------|------|------|--------|-------------|----------------|
| Display Hero | Inter | 56px | 400 | 1.15 | -1.68px |
| Section Heading | Inter | 48px | 400 | 1.15 | -1.44px |
| Card Title | Inter | 24px | 400 | 1.15 | -0.72px |
| Sub-heading | Noto Sans | 22px | 400 | 1.35 | -0.44px |
| Feature | Inter | 18px | 600 | 1.35 | normal |
| Body | Noto Sans | 18px | 400 | 1.45 | normal |
| Body Standard | Noto Sans | 16px | 400–600 | 1.50 | -0.16px |
| Button | Inter | 17.5px | 700 | 1.29 | 0.175px |
| Caption | Inter | 14px | 400 | 1.71 | normal |
| Small | Inter | 12px | 400 | 1.15 | -0.36px |
| Micro Uppercase | Inter | 10.5px | 400 | 0.90 | uppercase |
...
- Apply Inter with OpenType character variants
...
- "Create hero: white background. Inter 56px, line-height 1.15, letter-spacing -1.68px. Blue CTA (#5b76fe). Outlined secondary (1px solid #c7cad5, 8px radius)."
