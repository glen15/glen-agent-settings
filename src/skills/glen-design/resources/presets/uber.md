...
The signature typeface, Inter, is a proprietary geometric sans-serif with a distinctly square, engineered quality. Headlines in Inter Bold at 52px carry the weight of a billboard -- authoritative, direct, unapologetic. The companion face Inter handles body copy and buttons with a slightly softer, more readable character at medium weight (500). Together, they create a typographic system that feels like a transit map: clear, efficient, built for scanning at speed.
...
- Inter (headlines) + Inter (body/UI) -- proprietary geometric sans-serif family
...
### Font Family
- **Headline / Display**: `Inter`, with fallbacks: `Inter, system-ui, Helvetica Neue, Helvetica, Arial, sans-serif`
- **Body / UI**: `Inter`, with fallbacks: `system-ui, Helvetica Neue, Helvetica, Arial, sans-serif`

*Note: Inter and Inter are proprietary typefaces. For external implementations, use `system-ui` or Inter as the closest available substitute. The geometric, square-proportioned character of Inter can be approximated with Inter or DM Sans.*

### Hierarchy

| Role | Font | Size | Weight | Line Height | Notes |
|------|------|------|--------|-------------|-------|
| Display / Hero | Inter | 52px (3.25rem) | 700 | 1.23 (tight) | Maximum impact, billboard presence |
| Section Heading | Inter | 36px (2.25rem) | 700 | 1.22 (tight) | Major section anchors |
| Card Title | Inter | 32px (2rem) | 700 | 1.25 (tight) | Card and feature headings |
| Sub-heading | Inter | 24px (1.5rem) | 700 | 1.33 | Secondary section headers |
| Small Heading | Inter | 20px (1.25rem) | 700 | 1.40 | Compact headings, list titles |
| Nav / UI Large | Inter | 18px (1.13rem) | 500 | 1.33 | Navigation links, prominent UI text |
| Body / Button | Inter | 16px (1rem) | 400-500 | 1.25-1.50 | Standard body text, button labels |
| Caption | Inter | 14px (0.88rem) | 400-500 | 1.14-1.43 | Metadata, descriptions, small links |
| Micro | Inter | 12px (0.75rem) | 400 | 1.67 (relaxed) | Fine print, legal text |

### Principles
- **Bold headlines, medium body**: Inter headings are exclusively weight 700 (bold) -- every headline hits with billboard force. Inter body and UI text uses 400-500, creating a clear visual hierarchy through weight contrast.
...
- **Two fonts, strict roles**: Inter is exclusively for headings. Inter is exclusively for body, buttons, links, and UI. The boundary is never crossed.
...
- Links: Inter at 14-18px, weight 500, in Uber Black
...
- Keep all headings in Inter Bold (700) for billboard-level impact
...
- Use Inter at weight 500 for navigation and prominent UI text
...
- Don't mix Inter into body text or Inter into headlines -- the hierarchy is strict
...
- Outfit controls (menu, close): 50% radius ensures large, easy-to-hit targets
...
- "Create a hero section on Pure White (#ffffff) with a headline at 52px Inter Bold (700), line-height 1.23. Use Uber Black (#000000) text. Add a subtitle in Body Gray (#4b4b4b) at 16px Inter weight 400 with 1.50 line-height. Place an Uber Black (#000000) pill CTA button with Pure White text, 999px radius, padding 10px 12px."
- "Design a category navigation bar with horizontal pill buttons. Each pill: Chip Gray (#efefef) background, Uber Black (#000000) text, 14px 16px padding, 999px border-radius. Active pill inverts to Uber Black background with Pure White text. Use Inter at 14px weight 500."
- "Build a feature card on Pure White (#ffffff) with 8px border-radius and shadow rgba(0,0,0,0.12) 0px 4px 16px. Title in Inter at 24px weight 700, description in Body Gray (#4b4b4b) at 16px Inter. Add a black pill CTA button at the bottom."
- "Create a dark footer on Uber Black (#000000) with Pure White (#ffffff) heading text in Inter at 20px weight 700. Footer links in Muted Gray (#afafaf) at 14px Inter. Links hover to Pure White. Multi-column grid layout."
...
4. Describe the font family explicitly -- "Inter Bold for the heading, Inter Medium for the label"
