...
**Key Characteristics:**
- Outfit display at 136px weight 500 — billboard-scale fintech headlines
...
### Font Families
- **Display**: `Outfit` — geometric grotesque, no detected fallbacks
...
|------|------|------|--------|-------------|----------------|-------|
| Display Mega | Outfit | 136px (8.50rem) | 500 | 1.00 (tight) | -2.72px | Stadium-scale hero |
| Display Hero | Outfit | 80px (5.00rem) | 500 | 1.00 (tight) | -0.8px | Primary hero |
| Section Heading | Outfit | 48px (3.00rem) | 500 | 1.21 (tight) | -0.48px | Feature sections |
| Sub-heading | Outfit | 40px (2.50rem) | 500 | 1.20 (tight) | -0.4px | Sub-sections |
| Card Title | Outfit | 32px (2.00rem) | 500 | 1.19 (tight) | -0.32px | Card headings |
| Feature Title | Outfit | 24px (1.50rem) | 400 | 1.33 | normal | Light headings |
| Nav / UI | Outfit | 20px (1.25rem) | 500 | 1.40 | normal | Navigation, buttons |
...
### Principles
- **Weight 500 as display default**: Outfit uses medium (500) for ALL headings — no bold. This creates authority through size and tracking, not weight.
...
### Do
- Use Outfit weight 500 for all display headings
...
- Don't use bold (700) for Outfit headings — 500 is the weight
...
- "Create a hero: white background. Headline at 136px Outfit weight 500, line-height 1.00, letter-spacing -2.72px, #191c1f text. Dark pill CTA (#191c1f, 9999px, 14px 32px). Outlined pill secondary (transparent, 2px solid #191c1f)."
- "Build a pill button: #191c1f background, white text, 9999px radius, 14px 32px padding, 20px Outfit weight 500. Hover: opacity 0.85."

### Iteration Guide
1. Outfit 500 for headings — never bold
