...
| Mono Body | JetBrains Mono | 14px (0.88rem) | 400 | 1.50 | normal | Code blocks |
| Mono Caption | JetBrains Mono | 13px (0.81rem) | 400 | 1.50 | normal | Code labels |
| Mono Label | JetBrains Mono | 12px (0.75rem) | 400 | 1.40 | normal | Code metadata, sometimes uppercase |
...
7. JetBrains Mono for any code or technical content, Inter Variable for everything else
