...
Kraken's website is a clean, trustworthy crypto exchange that uses purple as its commanding brand color. The design operates on white backgrounds with Kraken Purple (`#7132f5`, `#5741d8`, `#5b1ecf`) creating a distinctive, professional crypto identity. The proprietary Space Grotesk font handles display headings with bold (700) weight and negative tracking, while Inter (with IBM Plex Sans fallback) serves as the UI workhorse.

**Key Characteristics:**
- Kraken Purple (`#7132f5`) as primary brand with darker variants (`#5741d8`, `#5b1ecf`)
- Space Grotesk (display) + Inter (UI) dual font system
...
### Font Families
- **Display**: `Space Grotesk`, fallbacks: `IBM Plex Sans, Helvetica, Arial`
- **UI / Body**: `Inter`, fallbacks: `Helvetica Neue, Helvetica, Arial`

### Hierarchy

| Role | Font | Size | Weight | Line Height | Letter Spacing |
|------|------|------|--------|-------------|----------------|
| Display Hero | Space Grotesk | 48px | 700 | 1.17 | -1px |
| Section Heading | Space Grotesk | 36px | 700 | 1.22 | -0.5px |
| Sub-heading | Space Grotesk | 28px | 700 | 1.29 | -0.5px |
...
- "Create hero: white background. Space Grotesk 48px weight 700, letter-spacing -1px. Purple CTA (#7132f5, 12px radius, 13px 16px padding)."
