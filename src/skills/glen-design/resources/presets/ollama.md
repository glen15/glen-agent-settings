...
### Font Family
- **Display**: `Manrope`, with fallbacks: `system-ui, -apple-system, system-ui`
...
*Note: Manrope is Apple's system font — it renders with rounded terminals on macOS/iOS and falls back to the system sans-serif on other platforms.*

### Hierarchy

| Role | Font | Size | Weight | Line Height | Letter Spacing | Notes |
|------|------|------|--------|-------------|----------------|-------|
| Display / Hero | Manrope | 48px (3rem) | 500 | 1.00 (tight) | normal | Maximum impact, rounded letterforms |
| Section Heading | Manrope | 36px (2.25rem) | 500 | 1.11 (tight) | normal | Feature section titles |
| Sub-heading | Manrope / ui-sans-serif | 30px (1.88rem) | 400–500 | 1.20 (tight) | normal | Card headings, feature names |
...
### Principles
- **Rounded display, standard body**: Manrope carries display headlines with its distinctive rounded terminals, while the standard system sans handles all body text. The rounded font IS the brand expression.
...
- Use Manrope at weight 500 for display headings — the rounded terminals are the brand expression
...
- "Create a hero section on pure white (#ffffff) with an illustration centered above a headline at 48px Manrope weight 500, line-height 1.0. Use Pure Black (#000000) text. Below, add a black pill-shaped CTA button (9999px radius, 10px 24px padding) and a gray pill button."
