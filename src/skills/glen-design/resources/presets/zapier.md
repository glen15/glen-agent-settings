...
The typographic system is a deliberate interplay of two distinct personalities. **Outfit** -- a geometric, wide-set display face -- handles hero-scale headlines at 56-80px with medium weight (500) and extraordinarily tight line-heights (0.90), creating headlines that compress vertically like stacked blocks. **Inter** serves as the workhorse for everything else, from section headings to body text and navigation, with fallbacks to Helvetica and Arial. **Fraunces**, an elegant thin-weight serif with aggressive negative letter-spacing (-1.6px to -1.92px), makes occasional appearances for softer editorial moments. This three-font system gives Zapier the ability to shift register -- from bold and punchy (Degular) to clean and functional (Inter) to refined and literary (Fraunces).
...
- Outfit for hero headlines at 0.90 line-height -- compressed, impactful, modern
- Inter as the universal UI font across all functional typography
- Fraunces for editorial accents -- thin-weight serif with extreme negative tracking
...
### Font Families
- **Display**: `Outfit` -- wide geometric display face for hero headlines
- **Primary**: `Inter`, with fallbacks: `Helvetica, Arial`
- **Editorial**: `Fraunces` -- thin-weight serif for editorial moments
...
|------|------|------|--------|-------------|----------------|-------|
| Display Hero XL | Outfit | 80px (5.00rem) | 500 | 0.90 (tight) | normal | Maximum impact, compressed block |
| Display Hero | Outfit | 56px (3.50rem) | 500 | 0.90-1.10 (tight) | 0-1.12px | Primary hero headlines |
| Display Hero SM | Outfit | 40px (2.50rem) | 500 | 0.90 (tight) | normal | Smaller hero variant |
| Display Button | Outfit | 24px (1.50rem) | 600 | 1.00 (tight) | 1px | Large CTA button text |
| Section Heading | Inter | 48px (3.00rem) | 500 | 1.04 (tight) | normal | Major section titles |
| Editorial Heading | Fraunces | 48px (3.00rem) | 250 | normal | -1.92px | Thin editorial headlines |
| Editorial Sub | Fraunces | 40px (2.50rem) | 300 | 1.08 (tight) | -1.6px | Editorial subheadings |
...
### Principles
- **Three-font system, clear roles**: Outfit commands attention at hero scale only. Inter handles everything functional. Fraunces adds editorial warmth sparingly.
...
- **Negative tracking for elegance**: Fraunces uses -1.6px to -1.92px letter-spacing for its thin-weight editorial headlines.
...
**Social Proof Icons**
- Outfit icon buttons: 14px radius
...
- **Architectural compression**: Outfit headlines at 0.90 line-height compress vertically, contrasting with the open spacing around them.
...
### Do
- Use Outfit exclusively for hero-scale headlines (40px+) with 0.90 line-height for compressed impact
...
### Don't
- Don't use Outfit for body text or UI elements -- it's display-only
...
- Don't use Fraunces for functional UI -- it's an editorial accent at thin weights only
- Don't apply positive letter-spacing to Fraunces -- it uses aggressive negative tracking (-1.6px to -1.92px)
...
4. Three fonts, strict roles: Outfit (hero), Inter (UI), Fraunces (editorial)
