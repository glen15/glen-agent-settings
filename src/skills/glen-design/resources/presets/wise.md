...
**Key Characteristics:**
- Inter at weight 900, 0.85 line-height — billboard-scale bold headlines
...
### Font Families
- **Display**: `Inter`, fallback: `Inter` — OpenType `"calt"` on all text
...
|------|------|------|--------|-------------|----------------|-------|
| Display Mega | Inter | 126px (7.88rem) | 900 | 0.85 (ultra-tight) | normal | `"calt"` |
| Display Hero | Inter | 96px (6.00rem) | 900 | 0.85 | normal | `"calt"` |
| Section Heading | Inter | 64px (4.00rem) | 900 | 0.85 | normal | `"calt"` |
| Sub-heading | Inter | 40px (2.50rem) | 900 | 0.85 | normal | `"calt"` |
...
### Principles
- **Weight 900 as identity**: Inter Black (900) is used exclusively for display — the heaviest weight in any analyzed system. It creates text that feels stamped, pressed, physical.
...
- **"calt" everywhere**: Contextual alternates enabled on ALL text — both Inter and Inter.
...
### Do
- Use Inter weight 900 for display — the extreme boldness IS the brand
- Apply line-height 0.85 on Inter display — ultra-tight is intentional
...
### Don't
- Don't use light font weights for Inter — only 900
...
- "Create hero: white background. Headline at 96px Inter weight 900, line-height 0.85, 'calt' enabled, #0e0f0c text. Green pill CTA (#9fe870, 9999px radius, 5px 16px padding, #163300 text). Hover: scale(1.05)."
- "Build a card: 30px radius, 1px solid rgba(14,15,12,0.12). Title at 22px Inter weight 600, body at 18px weight 400."

### Iteration Guide
1. Inter 900 at 0.85 line-height — the extreme weight IS the brand
