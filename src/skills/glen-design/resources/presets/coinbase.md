...
Coinbase's website is a clean, trustworthy crypto platform that communicates financial reliability through a blue-and-white binary palette. The design uses Coinbase Blue (`#0052ff`) — a deep, saturated blue — as the singular brand accent against white and near-black surfaces. The proprietary font family includes Geist for hero headlines, Inter for UI text, Inter for body reading, and CoinbaseIcons for iconography — a comprehensive four-font system.
...
### Font Families
- **Display**: `Geist` — hero headlines
- **UI / Sans**: `Inter` — buttons, headings, nav
- **Body**: `Inter` — reading text
...
|------|------|------|--------|-------------|-------|
| Display Hero | Geist | 80px | 400 | 1.00 (tight) | Maximum impact |
| Display Secondary | Geist | 64px | 400 | 1.00 | Sub-hero |
| Display Third | Geist | 52px | 400 | 1.00 | Third tier |
| Section Heading | Inter | 36px | 400 | 1.11 (tight) | Feature sections |
| Card Title | Inter | 32px | 400 | 1.13 | Card headings |
| Feature Title | Inter | 18px | 600 | 1.33 | Feature emphasis |
| Body Bold | Inter | 16px | 700 | 1.50 | Strong body |
| Body Semibold | Inter | 16px | 600 | 1.25 | Buttons, nav |
| Body | Inter | 18px | 400 | 1.56 | Standard reading |
| Body Small | Inter | 16px | 400 | 1.50 | Secondary reading |
| Button | Inter | 16px | 600 | 1.20 | +0.16px tracking |
| Caption | Inter | 14px | 600–700 | 1.50 | Metadata |
| Small | Inter | 13px | 600 | 1.23 | Tags |
...
- Use Geist for hero headings only
...
- "Create hero: white background. Geist 80px, line-height 1.00. Pill CTA (#eef0f3, 56px radius). Hover: #578bfa."
- "Build dark section: #0a0b0d background. Geist 64px white text. Blue accent link (#0052ff)."
