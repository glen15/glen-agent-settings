...
- Single typeface system: Inter for everything from display to micro labels
...
### Font Family
- **Universal**: `Inter`, with fallback: `Inter Fallback`

*Note: Inter is a custom geometric sans-serif. For external implementations, Inter or DM Sans serve as close substitutes.*

### Hierarchy

| Role | Font | Size | Weight | Line Height | Letter Spacing | Notes |
|------|------|------|--------|-------------|----------------|-------|
| Display / Hero | Inter | 48px (3rem) | 400 | 1.00 (tight) | -1.2px | Maximum size, film-title presence |
| Section Heading | Inter | 40px (2.5rem) | 400 | 1.00–1.10 | -1px to 0px | Feature section titles |
| Sub-heading | Inter | 36px (2.25rem) | 400 | 1.00 (tight) | -0.9px | Secondary section markers |
| Card Title | Inter | 24px (1.5rem) | 400 | 1.00 (tight) | normal | Article and card headings |
| Feature Title | Inter | 20px (1.25rem) | 400 | 1.00 (tight) | normal | Small headings |
| Body / Button | Inter | 16px (1rem) | 400–600 | 1.30–1.50 | -0.16px to normal | Standard body, nav links |
| Caption / Label | Inter | 14px (0.88rem) | 500–600 | 1.25–1.43 | 0.35px (uppercase) | Metadata, section labels |
| Small | Inter | 13px (0.81rem) | 400 | 1.30 (tight) | -0.16px to -0.26px | Compact descriptions |
| Micro / Tag | Inter | 11px (0.69rem) | 450 | 1.30 (tight) | normal | Uppercase tags, tiny labels |

### Principles
- **One typeface, complete expression**: Inter handles every text role. The design achieves variety through size, weight, case, and letter-spacing rather than font-family switching.
...
- Links: Inter at 16px, weight 400–600
...
- Headline in 48px Inter, white on dark imagery
...
- Use Inter for all text — maintain the single-typeface commitment
...
- Don't use more than one typeface — Inter handles everything
...
- "Create a cinematic hero section: full-bleed dark background with a cinematic image overlay. Headline at 48px Inter weight 400, line-height 1.0, letter-spacing -1.2px in white. Minimal text below in Cool Slate (#767d88) at 16px."
...
- "Build a section label: 14px Inter weight 500, uppercase, letter-spacing 0.35px in Cool Slate (#767d88). No border, no background."
...
- "Design a mission statement section: Runway Black background, white text at 36px Inter, line-height 1.0, letter-spacing -0.9px. Centered, with generous vertical padding."

### Iteration Guide
1. Visual content first — always include cinematic photography
2. Use Inter for everything — specify size and weight, never change the font
