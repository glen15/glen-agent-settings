...
|------|------|------|--------|-------------|----------------|-------|
| Section Heading | Manrope | 28px (1.75rem) | 700 | 1.43 | normal | Primary headings |
| Card Heading | Manrope | 22px (1.38rem) | 600 | 1.18 (tight) | -0.44px | Category/card titles |
| Card Heading Medium | Manrope | 22px (1.38rem) | 500 | 1.18 (tight) | -0.44px | Lighter variant |
| Sub-heading | Manrope | 21px (1.31rem) | 700 | 1.43 | normal | Bold sub-headings |
| Feature Title | Manrope | 20px (1.25rem) | 600 | 1.20 (tight) | -0.18px | Feature headings |
| UI Medium | Manrope | 16px (1.00rem) | 500 | 1.25 (tight) | normal | Nav, emphasized text |
| UI Semibold | Manrope | 16px (1.00rem) | 600 | 1.25 (tight) | normal | Strong emphasis |
| Button | Manrope | 16px (1.00rem) | 500 | 1.25 (tight) | normal | Button labels |
| Body / Link | Manrope | 14px (0.88rem) | 400 | 1.43 | normal | Standard body |
| Body Medium | Manrope | 14px (0.88rem) | 500 | 1.29 (tight) | normal | Medium body |
| Caption Salt | Manrope | 14px (0.88rem) | 600 | 1.43 | normal | `"salt"` feature |
| Small | Manrope | 13px (0.81rem) | 400 | 1.23 (tight) | normal | Descriptions |
| Tag | Manrope | 12px (0.75rem) | 400–700 | 1.33 | normal | Tags, prices |
| Badge | Manrope | 11px (0.69rem) | 600 | 1.18 (tight) | normal | `"salt"` feature |
| Micro Uppercase | Manrope | 8px (0.50rem) | 700 | 1.25 (tight) | 0.32px | `text-transform: uppercase` |
...
- Use Manrope at weight 500–700 — the warm weight range is intentional
