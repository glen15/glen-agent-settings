...
- **Secondary Display**: `Inter` (`__basier_a58b65`), with fallbacks: `Arial, Helvetica`
...
| Sub-heading | Inter / Inter | 24px (1.5rem) | 600–700 | 1.17–1.38 | normal | Card headings |
| Feature Title | Inter / Inter | 20px (1.25rem) | 600–700 | 1.40 | normal | Small feature titles |
...
- **Dual sans-serif**: Inter handles display and body; Inter handles feature section headings at 600 weight. This creates a subtle personality shift between "data/performance" (Inter) and "product/feature" (Inter) contexts.
