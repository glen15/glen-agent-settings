...
Airtable's website is a clean, enterprise-friendly platform that communicates "sophisticated simplicity" through a white canvas with deep navy text (`#181d26`) and Airtable Blue (`#1b61c9`) as the primary interactive accent. The Space Grotesk font family (display + text variants) creates a Swiss-precision typography system with positive letter-spacing throughout.

**Key Characteristics:**
- White canvas with deep navy text (`#181d26`)
- Airtable Blue (`#1b61c9`) as primary CTA and link color
- Space Grotesk + Space Grotesk dual font system
...
### Font Families
- **Primary**: `Space Grotesk`, fallbacks: `-apple-system, system-ui, Segoe UI, Roboto`
- **Display**: `Space Grotesk`, fallback: `Space Grotesk`

### Hierarchy

| Role | Font | Size | Weight | Line Height | Letter Spacing |
|------|------|------|--------|-------------|----------------|
| Display Hero | Space Grotesk | 48px | 400 | 1.15 | normal |
| Display Bold | Space Grotesk | 48px | 900 | 1.50 | normal |
| Section Heading | Space Grotesk | 40px | 400 | 1.25 | normal |
| Sub-heading | Space Grotesk | 32px | 400–500 | 1.15–1.25 | normal |
| Card Title | Space Grotesk | 24px | 400 | 1.20–1.30 | 0.12px |
| Feature | Space Grotesk | 20px | 400 | 1.25–1.50 | 0.1px |
| Body | Space Grotesk | 18px | 400 | 1.35 | 0.18px |
| Body Medium | Space Grotesk | 16px | 500 | 1.30 | 0.08–0.16px |
| Button | Space Grotesk | 16px | 500 | 1.25–1.30 | 0.08px |
| Caption | Space Grotesk | 14px | 400–500 | 1.25–1.35 | 0.07–0.28px |
...
### Inputs: Standard Space Grotesk styling
...
## 7. Do's and Don'ts
### Do: Use Airtable Blue for CTAs, Space Grotesk with positive tracking, 12px radius buttons
