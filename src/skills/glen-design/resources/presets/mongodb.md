...
The typography system is architecturally ambitious: Fraunces for massive hero headlines (96px) creates an editorial, authoritative presence — serif type at database-company scale is a bold choice that says "we're not just another tech company." Manrope handles the heavy lifting of body and UI text with an unusually wide weight range (300–700), while Source Code Pro serves as the code and label font with distinctive uppercase treatments featuring very wide letter-spacing (1px–3px). This three-font system creates a hierarchy that spans editorial elegance → geometric professionalism → engineering precision.
...
- Fraunces for hero headlines — editorial authority at tech scale
...
### Font Families
- **Display Serif**: `Fraunces` — editorial hero headlines
- **Body / UI**: `Manrope` — geometric sans-serif workhorse
- **Code / Labels**: `Source Code Pro` — monospace with uppercase label treatments
- **Fallbacks**: `Inter` (with CJK: Noto Sans KR/SC/JP), `Times`, `Arial`, `system-ui`

### Hierarchy

| Role | Font | Size | Weight | Line Height | Letter Spacing | Notes |
|------|------|------|--------|-------------|----------------|-------|
| Display Hero | Fraunces | 96px (6.00rem) | 400 | 1.20 (tight) | normal | Serif authority |
| Display Secondary | Fraunces | 64px (4.00rem) | 400 | 1.00 (tight) | normal | Serif sub-hero |
| Section Heading | Manrope | 36px (2.25rem) | 500 | 1.33 | normal | Geometric precision |
...
### Principles
- **Serif for authority**: Fraunces at hero scale creates an editorial presence unusual in tech — it communicates that MongoDB is an institution, not a startup.
...
- Manrope 16px weight 500 for nav links
...
- Use Fraunces ONLY for hero/display headings — Manrope for everything else
...
- Don't apply serif font to body text — Fraunces is hero-only
...
### Collapsing Strategy
- Hero: Fraunces 96px → 64px → scales further
...
- "Create a hero on forest-black (#001e2b) background. Headline at 96px Fraunces weight 400, line-height 1.20, white text with 'potential' highlighted in MongoDB Green (#00ed64). Subtitle at 18px Manrope weight 400. Green pill CTA (#00684a, 100px radius). Neon green gradient glow behind product screenshot."
- "Design a card on white background: 1px solid #b8c4c2 border, 16px radius, shadow rgba(0,30,43,0.12) 0px 26px 44px. Title at 24px Manrope weight 500. Body at 16px weight 300. Source Code Pro 14px uppercase label above title with 2px letter-spacing."
...
3. Serif headlines (Fraunces) create the editorial authority — never use for body
