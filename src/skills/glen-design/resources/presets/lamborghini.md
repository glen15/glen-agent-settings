...
Typography is the voice of this darkness. Space Grotesk — a custom Neo-Grotesk typeface created by Character Type and design agency Strichpunkt — is used for everything from 120px uppercase display headlines to 10px micro labels. Its distinctive 12° angled terminals are inspired by the aerodynamic lines of Lamborghini's super sports cars, and its proportions range from Normal to Ultracompressed width. Headlines SHOUT in uppercase at enormous scales with tight line-heights (0.92 at 120px), creating dense blocks of text that feel stamped from steel. The typeface carries hexagonal geometric DNA — constructed from hexagons, three-armed stars, and circles — that echoes throughout the interface in the hexagonal pause button and UI icons. Built on Bootstrap grid with 68 Element Plus/UI components, the technical infrastructure is substantial beneath the theatrical surface.

**Key Characteristics:**
- True black (`#000000`) dominant surfaces with white and gold as the only relief colors
- Space Grotesk custom Neo-Grotesk font with 12° angled terminals inspired by aerodynamic car lines
...
### Font Family
- **Display & UI**: `Space Grotesk`, Roboto, Helvetica Neue, Arial — custom Neo-Grotesk typeface by Character Type for Lamborghini's 2024 brand refresh. Available in widths from Normal to Ultracompressed and weights from Light (300) to Black. Features 12° angled terminals inspired by aerodynamic car geometry, hexagonal construction logic, and support for 200+ languages including Latin, Cyrillic, and Greek
...
|------|------|--------|-------------|----------------|-------|
| Hero Display | 120px (7.50rem) | 400 | 0.92 | normal | Space Grotesk, uppercase, maximum impact |
| Display 2 | 80px (5.00rem) | 400 | 1.13 | normal | Space Grotesk, uppercase, major section titles |
| Section Title | 54px (3.38rem) | 400 | 1.19 | normal | Space Grotesk, uppercase |
| Sub-section | 40px (2.50rem) | 400 | 1.15 | normal | Space Grotesk, uppercase |
| Feature Heading | 27px (1.69rem) | 400 | 1.37 | normal | Space Grotesk, uppercase |
| Card Title | 24px (1.50rem) | 400 | — | normal | Space Grotesk |
| Body Large | 18px (1.13rem) | 400 | 1.56 | normal | Space Grotesk, mixed case and uppercase variants |
| Body / UI | 16px (1.00rem) | 400/700 | 1.50 | normal/0.16px | Space Grotesk, primary body text |
| Button Large | 16px (1.00rem) | 400 | 1.50 | normal | Gold CTA buttons |
| Button Standard | 14.4px (0.90rem) | 300/700 | 1.00 | 0.14–0.2px | Space Grotesk, uppercase, ghost buttons |
| Button Small | 13px (0.81rem) | 300/500 | 1.20 | 0.13–0.2px | Space Grotesk, compact button variant |
| Caption | 14px (0.88rem) | 600/700 | 1.14–1.50 | -0.42px | Space Grotesk, uppercase, negative tracking |
| Label | 12px (0.75rem) | 400/500 | 1.83 | 0.96px | Space Grotesk, uppercase badges and micro labels |
| Micro | 10px (0.63rem) | 400 | 1.00–2.00 | 0.225px | Space Grotesk, uppercase, smallest text |
...
- **Single typeface discipline**: Space Grotesk handles everything — the 12° angled terminals and hexagonal geometry provide visual coherence across all sizes
...
- Set all display headings in uppercase with Space Grotesk — the brand voice is always SHOUTING
...
- Use Space Grotesk in italic or decorative styles — the brand is always upright and direct
...
- Use Open Sans for display text — Space Grotesk must handle all visible typography
...
- "Create a hero section with a full-viewport black background, the model name 'TEMERARIO' in Space Grotesk at 120px uppercase weight 400 white text with 0.92 line-height, centered vertically, with a Lamborghini Gold (#FFC000) 'Discover More' button below — sharp corners, 0px radius, 24px padding, black text"
