...
- Geist with extreme negative tracking at display sizes, creating a precision-engineered typographic voice
...
### Font Family
- **Display / Headline**: `Geist`, fallback: `Geist Fallback, ui-sans-serif, system-ui`
- **Body / UI**: `Geist`, fallback: `Geist Fallback, ui-sans-serif, system-ui`
...
*Note: Geist is a custom typeface. For external implementations, use Inter or Space Grotesk as the sans substitute (geometric, slightly condensed feel). IBM Plex Mono is available on Google Fonts.*

### Hierarchy

| Role | Font | Size | Weight | Line Height | Letter Spacing | Notes |
|------|------|------|--------|-------------|----------------|-------|
| Display / Hero | Geist | 112px (7rem) | 400 | 1.00 (tight) | -4.48px | Maximum impact, compressed tracking |
| Hero Secondary | Geist | 72px (4.5rem) | 400 | 1.05 (tight) | -2.88px | Large section headers |
| Section Heading | Geist | 48px (3rem) | 400 | 1.08 (tight) | -1.68px | Primary section anchors |
| Heading Large | Geist | 38px (2.38rem) | 400 | 1.10 (tight) | -1.14px | Feature section titles |
| Heading Medium | Geist | 32px (2rem) | 425 | 1.24 (tight) | -0.32px | Card titles, subsection headers |
| Heading Small | Geist | 24px (1.5rem) | 425 | 1.24 (tight) | -0.24px | Smaller feature headings |
| Subheading | Geist | 20px (1.25rem) | 425 | 1.13 (tight) | -0.2px | Sub-section markers |
| Body Large | Geist | 18px (1.13rem) | 400 | 1.50 | -0.18px | Intro paragraphs, descriptions |
| Body | Geist | 16px (1rem) | 400 | 1.50 | normal | Standard body text |
| Body Small | Geist | 15px (0.94rem) | 400 | 1.50 | -0.15px | Compact body text |
| Caption | Geist | 13px (0.81rem) | 400-500 | 1.30-1.50 | -0.13px | Metadata, descriptions, tags |
| Small Caption | Geist | 12px (0.75rem) | 400 | 1.50 | -0.12px | Footnotes, timestamps |
| Micro / Label | Geist | 11px (0.69rem) | 500-600 | 1.00-1.50 | normal | Uppercase labels, tiny badges |
...
- **Single font, multiple registers**: Geist handles both editorial display and functional UI text. The weight range is narrow (400-425 for most, 500-600 only for tiny labels), keeping the voice consistent.
...
- Font: 11px Geist, weight 600, uppercase
...
- Links: Geist 16px, Silver (`#b9b9b9`)
