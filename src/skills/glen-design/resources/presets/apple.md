...
The typography anchors everything. San Francisco (Inter for large sizes, Inter for body) is Apple's proprietary typeface, engineered with optical sizing that automatically adjusts letterforms depending on point size. At display sizes (56px), weight 600 with a tight line-height of 1.07 and subtle negative letter-spacing (-0.28px) creates headlines that feel machined rather than typeset — precise, confident, and unapologetically direct. At body sizes (17px), the tracking loosens slightly (-0.374px) and line-height opens to 1.47, creating a reading rhythm that is comfortable without ever feeling slack.
...
**Key Characteristics:**
- Inter/Text with optical sizing — letterforms adapt automatically to size context
...
### Font Family
- **Display**: `Inter`, with fallbacks: `SF Pro Icons, Helvetica Neue, Helvetica, Arial, sans-serif`
- **Body**: `Inter`, with fallbacks: `SF Pro Icons, Helvetica Neue, Helvetica, Arial, sans-serif`
- Inter is used at 20px and above; Inter is optimized for 19px and below.

### Hierarchy

| Role | Font | Size | Weight | Line Height | Letter Spacing | Notes |
|------|------|------|--------|-------------|----------------|-------|
| Display Hero | Inter | 56px (3.50rem) | 600 | 1.07 (tight) | -0.28px | Product launch headlines, maximum impact |
| Section Heading | Inter | 40px (2.50rem) | 600 | 1.10 (tight) | normal | Feature section titles |
| Tile Heading | Inter | 28px (1.75rem) | 400 | 1.14 (tight) | 0.196px | Product tile headlines |
| Card Title | Inter | 21px (1.31rem) | 700 | 1.19 (tight) | 0.231px | Bold card headings |
| Sub-heading | Inter | 21px (1.31rem) | 400 | 1.19 (tight) | 0.231px | Regular card headings |
| Nav Heading | Inter | 34px (2.13rem) | 600 | 1.47 | -0.374px | Large navigation headings |
| Sub-nav | Inter | 24px (1.50rem) | 300 | 1.50 | normal | Light sub-navigation text |
| Body | Inter | 17px (1.06rem) | 400 | 1.47 | -0.374px | Standard reading text |
| Body Emphasis | Inter | 17px (1.06rem) | 600 | 1.24 (tight) | -0.374px | Emphasized body text, labels |
| Button Large | Inter | 18px (1.13rem) | 300 | 1.00 (tight) | normal | Large button text, light weight |
| Button | Inter | 17px (1.06rem) | 400 | 2.41 (relaxed) | normal | Standard button text |
| Link | Inter | 14px (0.88rem) | 400 | 1.43 | -0.224px | Body links, "Learn more" |
| Caption | Inter | 14px (0.88rem) | 400 | 1.29 (tight) | -0.224px | Secondary text, descriptions |
| Caption Bold | Inter | 14px (0.88rem) | 600 | 1.29 (tight) | -0.224px | Emphasized captions |
| Micro | Inter | 12px (0.75rem) | 400 | 1.33 | -0.12px | Fine print, footnotes |
| Micro Bold | Inter | 12px (0.75rem) | 600 | 1.33 | -0.12px | Bold fine print |
| Nano | Inter | 10px (0.63rem) | 400 | 1.47 | -0.08px | Legal text, smallest size |
...
- Product name as the primary headline (Inter, 56px, weight 600)
...
### Do
- Use Inter at 20px+ and Inter below 20px — respect the optical sizing boundary
...
- "Create a hero section on black background. Headline at 56px Inter weight 600, line-height 1.07, letter-spacing -0.28px, color white. One-line subtitle at 21px Inter weight 400, line-height 1.19, color white. Two pill CTAs: 'Learn more' (transparent bg, white text, 1px solid white border, 980px radius) and 'Buy' (Apple Blue #0071e3 bg, white text, 8px radius, 8px 15px padding)."
- "Design a product card: #f5f5f7 background, 8px border-radius, no border, no shadow. Product image top 60% of card on solid background. Title at 28px Inter weight 400, letter-spacing 0.196px, line-height 1.14. Description at 14px Inter weight 400, color rgba(0,0,0,0.8). 'Learn more' and 'Shop' links in #0066cc at 14px."
- "Build the Apple navigation: sticky, 48px height, background rgba(0,0,0,0.8) with backdrop-filter: saturate(180%) blur(20px). Links at 12px Inter weight 400, white text. Apple logo left, links centered, search and bag icons right."
...
- "Design a 'Learn more' link: text #0066cc on light bg or #2997ff on dark bg, 14px Inter, underline on hover. After the text, include a right-arrow chevron character (>). Wrap in a container with 980px border-radius for pill shape when used as a standalone CTA."
...
3. Typography optical sizing: Inter at 20px+, Inter below — never mix
