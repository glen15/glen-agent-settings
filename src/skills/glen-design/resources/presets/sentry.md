...
- "Space Grotesk" display font for brand personality at hero scale
...
### Font Families
- **Display**: `Space Grotesk` — brand personality font for hero headings
...
|------|------|------|--------|-------------|----------------|-------|
| Display Hero | Space Grotesk | 88px (5.50rem) | 700 | 1.20 (tight) | normal | Maximum impact, brand voice |
| Display Secondary | Space Grotesk | 60px (3.75rem) | 500 | 1.10 (tight) | normal | Secondary hero text |
...
### Principles
- **Dual personality**: Space Grotesk brings irreverent brand character at display scale; Rubik provides clean professionalism for everything functional.
...
- Use Space Grotesk ONLY for hero/display headings — Rubik for everything else
...
- Don't apply Space Grotesk to body text or UI elements — it's display-only
...
### Collapsing Strategy
- Hero text: 88px Space Grotesk → 60px → mobile scales
...
- "Create a hero section on deep purple background (#1f1633). Headline at 88px Space Grotesk weight 700, line-height 1.20, white text. Sub-text at 16px Rubik weight 400, line-height 1.50. White solid CTA button (8px radius, 12px 16px padding), hover transitions to #6a5fc1."
...
6. Rubik handles 90% of typography — Space Grotesk is hero-only
