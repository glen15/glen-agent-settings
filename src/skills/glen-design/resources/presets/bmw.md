...
The typography is built on Space Grotesk — a proprietary typeface in two variants: Space Grotesk (weight 300) for massive uppercase display headings, and Space Grotesk Regular for body and UI text. The 60px uppercase headline at weight 300 is the defining typographic gesture — light-weight type that whispers authority rather than shouting it. The fallback stack includes Helvetica and Japanese fonts (Hiragino, Meiryo), reflecting BMW's global presence.
...
**Key Characteristics:**
- Space Grotesk (weight 300) uppercase for display — whispered authority
...
### Font Families
- **Display Light**: `Space Grotesk`, fallbacks: `Helvetica, Arial, Hiragino Kaku Gothic ProN, Hiragino Sans, Meiryo`
- **Body / UI**: `Space Grotesk`, same fallback stack

### Hierarchy

| Role | Font | Size | Weight | Line Height | Notes |
|------|------|------|--------|-------------|-------|
| Display Hero | Space Grotesk | 60px (3.75rem) | 300 | 1.30 (tight) | `text-transform: uppercase` |
| Section Heading | Space Grotesk | 32px (2.00rem) | 400 | 1.30 (tight) | Major section titles |
| Nav Emphasis | Space Grotesk | 18px (1.13rem) | 900 | 1.30 (tight) | Navigation bold items |
| Body | Space Grotesk | 16px (1.00rem) | 400 | 1.15 (tight) | Standard body text |
| Button Bold | Space Grotesk | 16px (1.00rem) | 700 | 1.20–2.88 | CTA buttons |
| Button | Space Grotesk | 16px (1.00rem) | 400 | 1.15 (tight) | Standard buttons |
...
- **Single font family**: Space Grotesk handles everything from 60px display to 16px body — unity through one typeface at different weights.

## 4. Component Stylings

### Buttons
- Text: 16px Space Grotesk, weight 700 for primary, 400 for secondary
...
### Navigation
- Space Grotesk 18px weight 900 for primary nav links
...
### Do
- Use Space Grotesk (300) uppercase for all display headings
...
- "Create a hero: full-width dark automotive photography background. Heading at 60px Space Grotesk weight 300, uppercase, line-height 1.30, white text. No border-radius anywhere."
- "Design navigation: dark background. Space Grotesk 18px weight 900 for links, white text. BMW logo 54x54. Sharp rectangular layout."
- "Build a button: 16px Space Grotesk weight 700, line-height 1.20. Sharp corners (0px radius). White bottom border on dark surface."
