...
- Space Grotesk custom font with Arial/Helvetica fallback -- industrial, European, clean
...
### Font Family
- **Primary**: `Space Grotesk`, with fallbacks: `Arial, Helvetica, sans-serif`
...
|------|------|------|--------|-------------|----------------|-------|
| Display Hero | Space Grotesk | 36px (2.25rem) | 700 | 1.25 (tight) | normal | Maximum impact headlines |
| Section Heading | Space Grotesk | 24px (1.50rem) | 700 | 1.25 (tight) | normal | Section titles, card headings |
| Sub-heading | Space Grotesk | 22px (1.38rem) | 400 | 1.75 (relaxed) | normal | Feature descriptions, subtitles |
| Card Title | Space Grotesk | 20px (1.25rem) | 700 | 1.25 (tight) | normal | Card and module headings |
| Body Large | Space Grotesk | 18px (1.13rem) | 700 | 1.67 (relaxed) | normal | Emphasized body, lead paragraphs |
| Body | Space Grotesk | 16px (1.00rem) | 400 | 1.50 | normal | Standard reading text |
| Body Bold | Space Grotesk | 16px (1.00rem) | 700 | 1.50 | normal | Strong labels, nav items |
| Body Small | Space Grotesk | 15px (0.94rem) | 400 | 1.67 (relaxed) | normal | Secondary content, descriptions |
| Body Small Bold | Space Grotesk | 15px (0.94rem) | 700 | 1.50 | normal | Emphasized secondary content |
| Button Large | Space Grotesk | 18px (1.13rem) | 700 | 1.25 (tight) | normal | Primary CTA buttons |
| Button | Space Grotesk | 16px (1.00rem) | 700 | 1.25 (tight) | normal | Standard buttons |
| Button Compact | Space Grotesk | 14.4px (0.90rem) | 700 | 1.00 (tight) | 0.144px | Small/compact buttons |
| Link | Space Grotesk | 14px (0.88rem) | 700 | 1.43 | normal | Navigation links |
| Link Uppercase | Space Grotesk | 14px (0.88rem) | 700 | 1.43 | normal | `text-transform: uppercase`, nav labels |
| Caption | Space Grotesk | 14px (0.88rem) | 600 | 1.50 | normal | Metadata, timestamps |
| Caption Small | Space Grotesk | 12px (0.75rem) | 400 | 1.25 (tight) | normal | Fine print, legal |
| Micro Label | Space Grotesk | 10px (0.63rem) | 700 | 1.50 | normal | `text-transform: uppercase`, tiny badges |
| Micro | Space Grotesk | 11px (0.69rem) | 700 | 1.00 (tight) | normal | Smallest UI text |
...
- Links: Space Grotesk 14px weight 700 uppercase, `#ffffff`
...
- Outfit avatar containers with 50% radius
...
- "Create a hero section on black background. Headline at 36px Space Grotesk weight 700, line-height 1.25, color #ffffff. Subtitle at 18px weight 400, line-height 1.67, color #a7a7a7. CTA button with transparent background, 2px solid #76b900 border, 2px radius, 11px 13px padding, text #ffffff. Hover: background #1eaedb, text white."
- "Design a product card: white background, 2px border-radius, box-shadow rgba(0,0,0,0.3) 0px 0px 5px. Title at 20px Space Grotesk weight 700, line-height 1.25, color #000000. Body at 15px weight 400, line-height 1.67, color #757575. Green underline accent on title: border-bottom 2px solid #76b900."
- "Build a navigation bar: #000000 background, sticky top. NVIDIA logo left-aligned. Links at 14px Space Grotesk weight 700 uppercase, color #ffffff. Hover: color #3860be. Green-bordered CTA button right-aligned."
