...
- **Body / UI**: `Inter`, with fallback: `Arial`
- **Code**: `Geist Mono`, with fallback: `Arial`
...
| Body Large | Inter | 20px (1.25rem) | 400 | 1.60 (relaxed) | normal | Intro paragraphs |
| Body / Nav | Inter | 17px (1.06rem) | 400–500 | 1.00–1.60 | normal | Navigation links, UI text |
| Body Standard | Inter | 16px (1rem) | 400–500 | 1.25–1.60 | normal | Standard body, button text |
| Body Small | Inter | 15px (0.94rem) | 400–500 | 1.00–1.60 | normal | Compact body text |
| Caption | Inter | 14px (0.88rem) | 400 | 1.43 | normal | Metadata, descriptions |
| Label | Inter | 12px (0.75rem) | 400–500 | 1.25–1.60 | 0.12px | Badges, small labels |
| Overline | Inter | 10px (0.63rem) | 400 | 1.60 | 0.5px | Uppercase overline labels |
| Micro | Inter | 9.6px (0.6rem) | 400 | 1.60 | 0.096px | Smallest text |
| Code | Geist Mono | 15px (0.94rem) | 400 | 1.60 | -0.32px | Inline code, terminal |

### Principles
- **Serif for authority, sans for utility**: Fraunces carries all headline content with medium weight (500), giving every heading the gravitas of a published title. Inter handles all functional UI text — buttons, labels, navigation — with quiet efficiency.
...
- "Create a hero section on Parchment (#f5f4ed) with a headline at 64px Fraunces weight 500, line-height 1.10. Use Anthropic Near Black (#141413) text. Add a subtitle in Olive Gray (#5e5d59) at 20px Inter with 1.60 line-height. Place a Terracotta Brand (#c96442) CTA button with Ivory text, 12px radius."
- "Design a feature card on Ivory (#faf9f5) with a 1px solid Border Cream (#f0eee6) border and comfortably rounded corners (8px). Title in Fraunces at 25px weight 500, description in Olive Gray (#5e5d59) at 16px Inter. Add a whisper shadow (rgba(0,0,0,0.05) 0px 4px 24px)."
...
- "Design a model comparison grid with three cards on Ivory surfaces. Each card gets a Border Warm (#e8e6dc) top border, model name in Fraunces at 25px, and description in Olive Gray at 15px Inter."
...
4. Describe serif vs sans usage explicitly — "Fraunces for the heading, Inter for the label"
