...
|------|------|------|--------|-------------|----------------|-------|
| Section Title | Outfit | 24px (1.50rem) | 700 | normal | normal | Bold title weight |
| Feature Heading | Outfit | 18px (1.13rem) | 600 | 1.30 (tight) | normal | Semibold section heads |
| Body Bold | Outfit | 16px (1.00rem) | 700 | normal | normal | Emphasized text |
| Body | Outfit | 16px (1.00rem) | 400 | normal | normal | Standard body |
| Button Uppercase | Outfit | 14px (0.88rem) | 600–700 | 1.00 (tight) | 1.4px–2px | `text-transform: uppercase` |
| Button | Outfit | 14px (0.88rem) | 700 | normal | 0.14px | Standard button |
| Nav Link Bold | Outfit | 14px (0.88rem) | 700 | normal | normal | Navigation |
| Nav Link | Outfit | 14px (0.88rem) | 400 | normal | normal | Inactive nav |
| Caption Bold | Outfit | 14px (0.88rem) | 700 | 1.50–1.54 | normal | Bold metadata |
| Caption | Outfit | 14px (0.88rem) | 400 | normal | normal | Metadata |
| Small Bold | Outfit | 12px (0.75rem) | 700 | 1.50 | normal | Tags, counts |
| Small | Outfit | 12px (0.75rem) | 400 | normal | normal | Fine print |
| Badge | Outfit | 10.5px (0.66rem) | 600 | 1.33 | normal | `text-transform: capitalize` |
| Micro | Outfit | 10px (0.63rem) | 400 | normal | normal | Smallest text |
...
- "Create a dark card: #181818 background, 8px radius. Title at 16px Outfit weight 700, white text. Subtitle at 14px weight 400, #b3b3b3. Shadow rgba(0,0,0,0.3) 0px 8px 8px on hover."
- "Design a pill button: #1f1f1f background, white text, 9999px radius, 8px 16px padding. 14px Outfit weight 700, uppercase, letter-spacing 1.4px."
