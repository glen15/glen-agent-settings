...
description: "프리미엄 UI 표준 강제 디자인 시스템. 엄격한 타이포그래피, 색상 보정, 비대칭 레이아웃, 마이크로모션 적용. /stitch-taste-design — 디자인 품질 검증 및 DESIGN.md 생성 시 사용."
user_invocable: true
argument-hint: [generate|review|apply]
allowed-tools:
  - "StitchMCP"
  - "Read"
  - "Write"
